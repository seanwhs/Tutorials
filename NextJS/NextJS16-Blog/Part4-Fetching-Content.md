  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-20">
      ...
      <div className="text-center">
        ...
        <p className="mt-6 text-2xl text-gray-600 dark:text-gray-400 font-light tracking-tight">
          Ramblings on AI, architecture, code, design, and building things that matter.
        </p>
